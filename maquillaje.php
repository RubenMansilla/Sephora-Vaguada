...
<body>
    ...
    <div class="main">
        ...
        <section class="contenedor contenedorProductos">
            <div class="producto">
                <img class="imgProducto1" src="img/maquillaje/High Impact High-Fi™ Full Volume.png"
        ...
        <section class="contenedor contenedorProductos">
            ...
            <div class="producto">
                <img class="imgProducto6" src="img/maquillaje/Double Wear 24H Stay-in-Place - Delineador de labios.jpg"
            ...
            <div class="producto">
                <img class="imgProducto3" src="img/maquillaje/Soft Matte & Easy - Barra de labios mate suave.jpg"
        ...
        <aside class="cajaProbador">
            ...
            <p class="textoProbador">¿Quires saber cómo te quedan tus productos favoritos de Sephora y de tus marcas
        ...
        <section class="contenedor contenedorProductos">
            ...
            <div class="producto">
                <img class="imgProducto3" src="img/maquillaje/Matte Velvet Skin - Base de maquillaje fluida mate.jpg"
            ...
            <div class="producto">
                <img class="imgProducto4" src="img/maquillaje/Eaze drop - Base de Maquillaje Efecto Difuminado.jpg"
        ...
        <section class="contenedorProductos">
            <div class="producto">
                <img class="imgProducto9" src="img/maquillaje/Positive Light - Corrector líquido ultraligero.jpg"
            ...
            <div class="producto">
                <img class="imgProducto7" src="img/maquillaje/Forever Skin Correct - Corrector de alta cobertura  .jpg"
        ...
        <section class="contenedorProductos">
            ...
            <div class="producto">
                <img class="imgProducto14" src="img/maquillaje/Forever Cushion Powder - Polvos sueltos de rostro .jpg"
        ...
        <section class="contenedorProductos">
            ...
            <div class="producto">
                <img class="imgProducto16" src="img/maquillaje/Brocha - Pincel delineador profesional n.º 22.jpg"

...
<body>
    ...
    <div class="main">
        ...
        <p class="subTitulo">Sumérgete en el mundo de las fragancias con nuestra colección de perfumes, cuidado personal
            e
            ideas para regalos.</p>
        ...
        <div class="banner">
            ...
            <img class="imgBanner"
                src="https://static.thcdn.com/images/medium/webp/widgets/95-es/15/original-ES_LF_EU_12_DAYS__-_Untitled_Page_%285%29-101115.jpeg"
                alt="Nuestro estado de ánimo al elegir perfume">
            <p class="textoBanner">Cuando utilizamos algún perfume, los sentimientos y el estado de ánimo que sentimos
                no
                son casualidad. Hace tiempo que se conocen los efectos de los perfumes a la hora de despertar diferentes
                sensaciones. Por ejemplo, solemos recurrir a los amaderados si estamos deprimidos para que nos recuerde
                la
        ...
        <section class="contenedor tipoProductos">
            ...
            <div class="producto">
                <img class="imgProducto1" src="img/perfumes/Good Girl 100ml Eau de Parfum Refillable Edition.png"
        ...
        <section class="tipoProductos">
            ...
            <div class="producto">
                <img class="imgProducto3" src="img/perfumes/Yves Saint Laurent Black Opium Eau de Parfum 30ml.png"
        ...
        <section class="tipoProductos">
            ...
            <div class="producto">
                <img class="imgProducto4" src="img/perfumes/Bad Boy 150ml Eau de Toilette Refillable Edition.png"
            ...
            <div class="producto">
                <img class="imgProducto5" src="img/perfumes/Jean Paul Gaultier Le Male Agua de Colonia 125ml.png"
            ...
            <div class="producto">
                <img class="imgProducto1" src="img/perfumes/Armani Acqua Di Gio Homme Eau de Toilette - 100ml.png"
